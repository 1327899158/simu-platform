...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  OPERATOR: [
    ...
    'ORDER_READ', 'ORDER_FORCE_CLOSE', 'AUDIT_READ',
    'DISPUTE_READ', 'DISPUTE_RESOLVE',
  ],
  AUDITOR: ['DASHBOARD_READ', 'USER_READ', 'ENGINEER_READ', 'ORDER_READ', 'AUDIT_READ', 'DISPUTE_READ'],
  ENGINEER_REVIEWER: ['DASHBOARD_READ', 'ENGINEER_READ', 'ENGINEER_APPROVE', 'ORDER_READ'],
});
